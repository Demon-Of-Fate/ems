...
if (isset($_POST['designation'])) {
    ...
    $result = $conn->query("SELECT MAX(depid) AS max_id FROM Department");
    ...
    $sql = "INSERT INTO department (depid, Department) VALUES ('$newDesigid', '$designation')";
...
if (isset($_POST['desi']) && isset($_POST['id'])) {
    ...
    $sql = "UPDATE department SET Department  = '$designation' WHERE depid = '$id'";
